...
public class Cardiologist extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Image imgsave = new Image("save-01.png");
		...
		//cancel.setMargin(cancelBtn, new Insets(0, 100, 0, -50));

		Image imgcancel = new Image("cancel.png");
		...
		Image imgback = new Image("backbutton-01.png");
